...
const scoreCard = document.getElementById('result') as HTMLElement;
const message4Player = document.getElementById('Message4player') as HTMLElement;
const word2ClickDisplay = document.getElementById('word2Click') as HTMLElement;

message4Player.innerText = 'Play the game!';
word2ClickDisplay.innerText = wordToClick;

const batons = document.querySelectorAll('.baton')as NodeListOf<HTMLButtonElement>;
...
const timerHtml = document.getElementById('timer') as HTMLElement;
